...
namespace FrameOfSystem3.Task
{
    class TaskBondHead : RunningTaskEx
    {
            ...
            switch (m_nSeqNum)
            {
                ...
                case (int)EN_LASER_WORK_STEP.READY_AND_WAIT_1:
                    ...
                    if (nPulseMode || nFeedMode || nOneCycle)
                    {
                        ...
                        if (nFeedMode)
                            m_enAction = EN_TASK_ACTION.LASER_WORK_FEED_MODE;
        ...
        private enum EN_LASER_WORK_STEP
        {
            ...
            READY_AND_WAIT_1 = 500,
            READY_AND_WAIT_2 = 600,
            AUTO_RUN_WORK_START = 700,

            BYPASS_MODE_READY_1 = 800,
            BYPASS_MODE_READY_2 = 900,
            BYPASS_RUN_WORK_START = 1000,
