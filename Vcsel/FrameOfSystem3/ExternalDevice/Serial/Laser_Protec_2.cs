...
{
    class ProtecLaserController_2
    {
        public enum EN_RESULT_2
        {
            WORKING,
            DONE,
            FAIL
        ...
        public enum EN_CONTROL_ALARM_2
        {
            NONE,
            SHORT_CHECK_ERROR,
            CURRENT_ERROR,
        ...
        public enum EN_MONITOR_ALARM_2
        {
            NONE,
            HUMIDITY_ERROR,
            SAFETY_ERROR,
         ...
         #region SingleTone
        private ProtecLaserController_2() { }
        private static ProtecLaserController_2 _Instance = null;
        public static ProtecLaserController_2 GetInstance() 
        {
            if (_Instance == null)
            {
                _Instance = new ProtecLaserController_2();
            }
            return _Instance; 
        }
        #endregion

        private class LaserControllerPort_2
        {
            private int m_nSerialPortIndex = 0;
            private string m_strReceiveData = string.Empty;
            private int m_nSeq = 0;

            public LaserControllerPort_2(int nPortIndex)
            {
        ...
        private Dictionary<int, LaserControllerPort_2> m_dicLaserPort = new Dictionary<int, LaserControllerPort_2>();
        private LaserControllerPort_2 m_LaserMonitorPort; //monitor는 항상 한개 일 것
        ...
        public bool Initialize(int[] arControlSerialIndex, int nMonitorIndex)
        {
            ...
            {
                m_dicLaserPort.Add(nIndex, new LaserControllerPort_2(arControlSerialIndex[nIndex]));
            ...
            #region Monitor
            m_LaserMonitorPort = new LaserControllerPort_2(nMonitorIndex);
        ...
        {
            bool bOpen = true;
            foreach (LaserControllerPort_2 cPortParam in m_dicLaserPort.Values)
            {
        ...
        public EN_RESULT_2 SetInitVoltageIOMode(int nPortIndex, bool[] arEnable, double[] arValue)
        {
            ...
            switch (m_dicLaserPort[nPortIndex].Seq)
            {
                case 0:
                    ...
                    //strMessage += ",000000"; // 2025.4.1 by ecchoi [ADD] "S" 커맨드는 이부분 삭제
                ...
                case 1:
                    if (CheckControlReciveDone(nPortIndex))
                    {
                        m_dicLaserPort[nPortIndex].Seq = 0;
                        m_dicTickTimeoverForLaserPort[nPortIndex].SetTickCount(TimeOut);
                        return EN_RESULT_2.DONE;
                    }
                    break;
            }
            return EN_RESULT_2.WORKING;
        }

        public EN_RESULT_2 SetStepVoltage(int nPortIndex, int nChannelIndex, bool bEnable, double[] arValue)
        {
            if (arValue.Length != 5)
                return EN_RESULT_2.FAIL;
        ...
        public EN_RESULT_2 SetStepTime(int nPortIndex, int[] arTime)
        {
            if (arTime.Length != 5)
                return EN_RESULT_2.FAIL;
        ...
        public EN_RESULT_2 SetTimeMode(int nPortIndex)
        {
            if (m_dicTickTimeoverForLaserPort[nPortIndex].IsTickOver(false))
            {
                m_dicLaserPort[nPortIndex].Seq = 0;
        ...
        public EN_RESULT_2 SetIOMode(int nPortIndex)
        {
            if (m_dicTickTimeoverForLaserPort[nPortIndex].IsTickOver(false))
            {
                m_dicLaserPort[nPortIndex].Seq = 0;
        ...
        public EN_RESULT_2 SetIOModeTimeLimit(int nLimitSec)
        {
        ...
        public EN_RESULT_2 ShortCheckStart(int nPortIndex)
        {
//             if (m_dicTickTimeoverForLaserPort[nPortIndex].IsTickOver(false))
//             {
//                 m_dicLaserPort[nPortIndex].Seq = 0;
...
//             }
        ...
        public EN_RESULT_2 GetAlarmCode(int nPortIndex, ref EN_CONTROL_ALARM_2 enAlarm)
        {
            if (m_dicTickTimeoverForLaserPort[nPortIndex].IsTickOver(false))
            {
                m_dicLaserPort[nPortIndex].Seq = 0;
        ...
        #region Monitor
        public EN_RESULT_2 GetAlarmCode(ref EN_MONITOR_ALARM_2 enAlarm)
        {
